                    ...
                    {!isEditing && (
                        <>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <img src={import.meta.env.VITE_API_PUBLIC_URL + product?.thumbnail} alt={product?.name} height={100} width={100} />
                            </div>
                        </>
                    )}
                ...
                <div className="flex flex-col w-1/2">
                    <div className="flex h-full w-full flex-col items-center justify-center gap-4">
                                ...
                                <AnimatePresence initial={false} custom={direction}>
                                    ...
                                    >
                                        <Image
                                            ...
                                            src={import.meta.env.VITE_API_PUBLIC_URL + productImages[imageIndex].image}
                                        />
                                    </motion.div>
                                </AnimatePresence>
                                ...
                                >
                                    <div className="relative">
                                        <Image
                                            removeWrapper
                                            alt={`Thumbnail ${index}`}
                                            src={import.meta.env.VITE_API_PUBLIC_URL + img.image}
                                            className="h-full w-full object-cover"
                                        />
                                        <Popover>
                                            <PopoverTrigger>
                        ...
                        <form onSubmit={handleSubmitImages} className="flex flex-col gap-2">
                            ...
                            {previewImage && (
                                <div className="flex flex-col gap-2">
                                    <Image src={import.meta.env.VITE_API_PUBLIC_URL + previewImage} alt={product?.name} height={100} width={100} />
