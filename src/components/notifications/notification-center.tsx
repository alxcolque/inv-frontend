...
export const NotificationCenter= ({ userId }: NotificationCenterProps) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <Badge color="danger" onClick={() => setIsOpen(!isOpen)} content={unreadCount > 99 ? '99+' : unreadCount} shape="circle">
          <Bell onClick={() => setIsOpen(!isOpen)} className="fill-current" size={25} />
        </Badge>
